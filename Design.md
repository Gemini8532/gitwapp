# Project Outline: Local Git Management Web Application
...
## 2. Backend Specification (Golang)
...
## 3. Frontend Specification (React + TypeScript)
...
### 4.1. Git Status Logic (Backend Calculation)
